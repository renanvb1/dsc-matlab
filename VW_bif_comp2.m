...
%   de Green para Tinj em VW multicamadas com as solucoes existentes, 
%   desenvolvidas por Barreto et al. e Mastbaum et al.
% =========================================================================
...
[pg, qg, rfg]=VW_gre7(t,nlay,q,rw,dfg,phi,h,ks,k,rs,re,etaw,etao,lwgr,logr,fcce);
[pm, qm, rfm]=VW_mast(t,nlay,q,rw,dfg,phi,h,ks,k,rs,re,etaw,etao,lwgr,logr,fcce);

% rfp=rfp(1,:);
% calculando a derivada da pressao
[dpg]=compute_derivative(t,pg,tp,fper);
[dpp]=compute_derivative(t,pp,tp,fper);
[dpm]=compute_derivative(t,pm,tp,fper);
